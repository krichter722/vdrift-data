...
void main()
{
	...
	//t = t * vec2(1.0,0.75);
	vec2 t = vec2(0.5,0.375) + vec2(0.5,0.375) * (newpos2.xy); //TODO:  0.5,0.375 is related to the screen ratio, replace it w/ actual values passed from the CPU
	
	const float samples = 8.0;
	const float sm1inv = 0.14286; //= 1.0/(samples-1.0);
