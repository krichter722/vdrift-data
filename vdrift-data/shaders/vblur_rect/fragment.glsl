...
void main()
{
	...
	/*final += 0.00390625 * texture2DRect(tu0_2DRect, tc + vec2(0.0, -4.0) );
	final += 0.03125000 * texture2DRect(tu0_2DRect, tc + vec2(0.0, -3.0) );
	final += 0.10937500 * texture2DRect(tu0_2DRect, tc + vec2(0.0, -2.0) );
	final += 0.21875000 * texture2DRect(tu0_2DRect, tc + vec2(0.0, -1.0) );
	final += 0.27343750 * texture2DRect(tu0_2DRect, tc + vec2(0.0, 0.0) );
	final += 0.21875000 * texture2DRect(tu0_2DRect, tc + vec2(0.0, 1.0) );
	final += 0.10937500 * texture2DRect(tu0_2DRect, tc + vec2(0.0, 2.0) );
	final += 0.03125000 * texture2DRect(tu0_2DRect, tc + vec2(0.0, 3.0) );
	final += 0.00390625 * texture2DRect(tu0_2DRect, tc + vec2(0.0, 4.0) );*/
	
	/*final += 0.02763056 * texture2DRect(tu0_2DRect, tc + vec2(0.0, -4.0) );
	final += 0.06628226 * texture2DRect(tu0_2DRect, tc + vec2(0.0, -3.0) );
	final += 0.12383157 * texture2DRect(tu0_2DRect, tc + vec2(0.0, -2.0) );
	final += 0.18017387 * texture2DRect(tu0_2DRect, tc + vec2(0.0, -1.0) );
